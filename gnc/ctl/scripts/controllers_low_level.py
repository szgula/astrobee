...
class OrientationController:
    def __init__(self, dt):
        ...
        self.contr_x = LQR([0.1393, 0.2629], 0.0442) # 0.0443    0.1796
        self.contr_y = LQR([0.1393, 0.2629], 0.0442)
        self.contr_z = LQR([0.1393, 0.2629], 0.0442)
        self.limit = 0.2 * 0.1
    
    def __call__(self, x_target, y_target, z_target, orientation, last_vel=None, t=None, target_vel=[0,0,0]):
        ...
        torque_x = self.contr_x(x_target, 0, vx, t, target_vel[0])
        torque_y = self.contr_y(y_target, 0, vy, t, target_vel[1])
        torque_z = self.contr_z(z_target, 0, vz, t, target_vel[2])
